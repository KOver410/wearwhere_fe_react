  ...
  const nearbyShops = [
    {
      ...
      featuredItems: [
        ...
        { id: 4, image: 'https://images.unsplash.com/photo-1606799609191-11b0dfb75be1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0b3RlJTIwYmFnJTIwY2FudmFzJTIwcHJvZHVjdCUyMHBob3RvfGVufDF8fHx8MTc3MjExMDc2Mnww&ixlib=rb-4.1.0&q=80&w=1080', name: t('item.toteBag'), price: 450000 },
        { id: 5, image: 'https://images.unsplash.com/photo-1721134619759-223b27177bb5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsaW5lbiUyMHBhbnRzJTIwZmFzaGlvbiUyMHByb2R1Y3QlMjBiZWlnZXxlbnwxfHx8fDE3NzIxMTA3NjJ8MA&ixlib=rb-4.1.0&q=80&w=1080', name: t('item.linenPants'), price: 590000 },
        { id: 6, image: 'https://images.unsplash.com/photo-1765248628055-ca8f89795fbc?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxidWNrZXQlMjBoYXQlMjBmYXNoaW9uJTIwYWNjZXNzb3J5JTIwcHJvZHVjdHxlbnwxfHx8fDE3NzIxMTAzODN8MA&ixlib=rb-4.1.0&q=80&w=1080', name: t('item.bucketHat'), price: 280000 },
      ],
    },
    {
      ...
      featuredItems: [
        ...
        { id: 5, image: 'https://images.unsplash.com/photo-1606799609191-11b0dfb75be1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0b3RlJTIwYmFnJTIwY2FudmFzJTIwcHJvZHVjdCUyMHBob3RvfGVufDF8fHx8MTc3MjExMDc2Mnww&ixlib=rb-4.1.0&q=80&w=1080', name: t('item.toteBag'), price: 450000 },
        { id: 6, image: 'https://images.unsplash.com/photo-1721134619759-223b27177bb5?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsaW5lbiUyMHBhbnRzJTIwZmFzaGlvbiUyMHByb2R1Y3QlMjBiZWlnZXxlbnwxfHx8fDE3NzIxMTA3NjJ8MA&ixlib=rb-4.1.0&q=80&w=1080', name: t('item.linenPants'), price: 590000 },
      ],
    },
  ];
            ...
            <motion.div key={shop.id} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
              ...
              <Link to="/stores" className="group block">
                <div className="grid md:grid-cols-12 gap-0 overflow-hidden bg-white transition-shadow hover:shadow-lg"
                  ...
                  <div className="md:col-span-3 p-5 md:p-6 flex flex-col justify-center" style={{ borderRight: '2px solid #e0d8cf' }}>
                  ...
                  <div className="md:col-span-5 p-4 md:p-5 flex items-center">
