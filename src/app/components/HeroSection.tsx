...
import ownYourFitImg from "figma:asset/1a3ecfcfac22b27f28a84b104b2e2f2af08112c0.png";
import limitedImg from "figma:asset/57c7275ffcf3e07274192b3249898a58d3cb60fe.png";
...
export function HeroSection() {
  ...
  return (
    <div className="relative overflow-hidden" style={{ backgroundColor: '#fff9f2' }}>
      <div className="relative z-10 mx-auto px-6 lg:px-9" style={{ maxWidth: 'calc(75% + 320px)' }}>
        <div className="flex flex-col lg:flex-row lg:h-[clamp(360px,42vw,480px)]">
          {/* ═══ LEFT: Main Typography ═══ */}
          <div className="relative z-10 flex flex-col justify-between py-8 md:py-10 lg:py-12 shrink-0 w-full lg:w-[48%]">
