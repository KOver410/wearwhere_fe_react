...
import img1 from 'figma:asset/5dfe423ed1632c2b81288d6bda4ed85e98137765.png';
import img2 from 'figma:asset/2b119c5c587bb5799778c62469ce97baa1ca8e72.png';
import img3 from 'figma:asset/3401053c788261c15dcdcb39e5f92043e890f86c.png';
import img4 from 'figma:asset/b38b06aa798d0e36ef15c78ae91bb94fc7db0abd.png';
import img5 from 'figma:asset/8fe3d6cc0b8bb4636000afa761192fc428a95eed.png';
import img6 from 'figma:asset/0c403ab53f289d7ea1208285c31da34152f58ad8.png';
import img7 from 'figma:asset/129d92277cbbacd12e439a2550519cc85a57e307.png';
import img8 from 'figma:asset/abf818ec55e61bbc5747bb3c0b1ae552bd9c19ab.png';
...
export function EditorialCollections() {
  ...
  // Touch-friendly: toggle on tap for tablet/touch devices
  ...
  return (
    <div className="py-12 md:py-20" style={{ backgroundColor: '#0d0d0d', fontFamily: "'Montserrat', sans-serif" }}>
      ...
      {/* ═══ Desktop: Expanding Accordion Slider (hidden on mobile) ═══ */}
      <motion.div
        initial={{ opacity: 0 }}
      ...
      <div className="md:hidden">
        ...
        >
          <style>{`.editorial-mobile-scroll::-webkit-scrollbar { display: none; }`}</style>
          {collections.map((col, i) => (
            <motion.div
              key={col.id}
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <Link to={`/product/${col.id}`} className="block relative overflow-hidden" style={{ height: '380px' }}>
                ...
                <div
                  className="absolute inset-0 pointer-events-none"
                  style={{ background: 'linear-gradient(to top, rgba(13,13,13,0.85) 0%, rgba(13,13,13,0.2) 50%, transparent 100%)' }}
                />
                {/* Slide number */}
                ...
                <div className="absolute top-4 right-4" style={{ zIndex: 3 }}>
                  <span style={{
                    ...
                    {lang === 'vi' ? col.tag.vi : col.tag.en}
                  </span>
                </div>
                {/* Content overlay */}
                <div className="absolute bottom-0 left-0 right-0 p-5" style={{ zIndex: 3 }}>
                  <div style={{ width: '24px', height: '2px', backgroundColor: col.accent, marginBottom: '12px' }} />
                  <h3 style={{
                    fontFamily: "'Oswald', sans-serif",
                    fontSize: '28px',
                    color: '#fff9f2',
                  ...
                  >
                    {lang === 'vi' ? 'KHÁM PHÁ' : 'EXPLORE'}
                    <svg width="16" height="6" viewBox="0 0 20 8" fill="none">
                      <path d="M0 4H18M18 4L14 0.5M18 4L14 7.5" stroke={col.accent} strokeWidth="1.5" />
                    </svg>
                  </div>
                </div>
