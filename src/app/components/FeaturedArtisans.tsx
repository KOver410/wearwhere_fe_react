...
import brandImg1 from "figma:asset/bc05621120d4db2bbbd43846c3c3991b34aec3c6.png";
import brandImg2 from "figma:asset/bad20da9e4fc651f15c7723fb8bde82ddda04a19.png";
import brandImg3 from "figma:asset/d2fc9947c889bd072d0bd3a03b51bf323d05cc72.png";
          ...
          {brands.map((brand, i) => (
            ...
            >
              <Link to={`/brands/${brand.id}`}
                className={`group block h-full ${i < 2 ? 'md:border-r-2' : ''}`}
              ...
              {/* Mobile separator between stacked cards */}
              {i < brands.length - 1 && (
                <div className="md:hidden h-[2px]" style={{ backgroundColor: '#0d0d0d' }} />
              )}
            </motion.div>
          ))}
        </div>
