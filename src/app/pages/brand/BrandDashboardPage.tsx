  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-[#64748B]">{v("Welcome back, Brand One. Here's what's happening with your store today.", 'Chào mừng trở lại, Brand One. Đây là tình hình cửa hàng của bạn hôm nay.')}</p>
      </div>
      ...
      <Card className="border-none shadow-sm">
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="w-[100px]">{v('Order ID', 'Mã đơn')}</TableHead>
